...
configs = [
   ...
   # "IPPC2014 -uf 2.0",                                         # The configuration that participated at IPPC 2014 
    "IPPC2011 -uf 0.11",                                         # The configuration that participated at IPPC 2014 with ASAP                    
    "IPPC2011 -uf 0.21",                                         # The configuration that participated at IPPC 2014 with ASAP
    "IPPC2011 -uf 0.51",                                         # The configuration that participated at IPPC 2014 with ASAP
    ...
    "IPPC2011 -uf 2.0 -ndn H",                                         # The configuration that participated at IPPC 2014 
    "IPPC2011 -uf 0.11 -ndn H",                                         # The configuration that participated at IPPC 2014 with ASAP                    
    "IPPC2011 -uf 0.21 -ndn H",                                         # The configuration that participated at IPPC 2014 with ASAP
    "IPPC2011 -uf 0.51 -ndn H",                                         # The configuration that participated at IPPC 2014 with ASAP
    "IPPC2011 -uf 0.75 -ndn H"
]
...
revision = "rev81553b56046366d1fce"
